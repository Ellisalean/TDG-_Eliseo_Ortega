  ...
  slides: [
    ...
    },
    {
      ...
      interaction: {
        ...
        revealItems: [
          ...
          { 
            title: '2. Alarma en Formación Docente (73%)', 
            text: 'Hallazgo Crítico', 
          ...
          { 
            title: '3. Aislamiento Motivacional (73%)', 
            text: 'Hallazgo Crítico', 
    ...
    },
    {
      ...
      interaction: {
        ...
        revealItems: [
          { 
            title: 'Desarrollo de Liderazgo Directivo', 
            text: 'Programas Especializados', 
            longContent: 'Establecer programas de desarrollo enfocados en habilidades comunicativas, gestión de equipos y estrategia educativa. Se sugiere colaboración con universidades para coaching en resolución de conflictos y gestión del cambio.', 
            icon: 'Briefcase', x: 25, y: 20 
          },
          { 
            title: 'Formación Continua Docente', 
            text: 'Plan de Capacitación Anual', 
            longContent: 'Impulsar un plan anual que aborde metodologías de enseñanza, uso de tecnología y atención a la diversidad. Implementar sistemas de mentoría entre docentes experimentados y noveles.', 
            icon: 'GraduationCap', x: 75, y: 15 
          },
          { 
            title: 'Foros de Motivación', 
            text: 'Desarrollo Profesional Mensual', 
            longContent: 'Establecer foros mensuales para intercambio de buenas prácticas, charlas de expertos y espacios de reflexión. Implementar reconocimientos trimestrales para aumentar la moral del equipo.', 
            icon: 'Zap', x: 50, y: 35 
          },
          { 
            title: 'Comunicación Efectiva', 
            text: 'Espacios Formales de Diálogo', 
            longContent: 'Reuniones regulares estructuradas con escucha activa y feedback constructivo. Uso de herramientas digitales y plataformas de comunicación interna para facilitar el intercambio de información.', 
            icon: 'MessageSquare', x: 30, y: 65 
          },
          { 
            title: 'Sistema de Retroalimentación', 
            text: 'Evaluación de Desempeño', 
            longContent: 'Crear un sistema con encuestas anónimas, observaciones mutuas y reuniones de progreso. La autocrítica positiva debe convertirse en un hábito común dentro del equipo docente.', 
            icon: 'RefreshCw', x: 70, y: 55 
          },
          { 
            title: 'Gestión del Aula Inclusiva', 
            text: 'Manejo de Grupos Desafiantes', 
            longContent: 'Capacitación focalizada en resolución de conflictos en el aula y promoción de ambientes de aprendizaje colaborativos para que el docente se sienta seguro y competente.', 
            icon: 'Users', x: 55, y: 80 
          },
          { 
            title: 'Cultura de Evaluación Continua', 
            text: 'Seguimiento de Impacto', 
            longContent: 'Mecanismo de seguimiento para evaluar la satisfacción del personal y los resultados académicos. Los datos deben servir para ajustar constantemente los programas de formación.', 
            icon: 'LineChart', x: 88, y: 85 
          }
        ]
      }
    },
